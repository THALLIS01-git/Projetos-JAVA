...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        String enterConta = scanner.nextLine().trim().toLowerCase();
        ...
        if (enterConta.equals("n")) { 
            ...
            System.out.println("Ok, " + usuario1.getNome() + ". Qual seu CPF? (Digite apenas números)");
            long cpfUsuario1 = Long.parseLong(scanner.nextLine()); 
            ...
            System.out.println("Qual seu endereço? (Apenas nome de rua e bairro)");
            String enderecoUsuario1 = scanner.nextLine();
            usuario1.setEndereco(enderecoUsuario1);
            
            System.out.println("Endereço: " + usuario1.getEndereco() + ", qual o número da residência?"); 
            ...
            System.out.println("Login concluído. Entrando...");
            Thread.sleep(3000);
            ...
            System.out.println("Ok, digite o CPF (Apenas números):");
            long cpfUsuario2 = Long.parseLong(scanner.nextLine());
